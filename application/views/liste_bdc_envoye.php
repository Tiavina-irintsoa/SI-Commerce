                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fw-medium"> 
                                    <a class="dropdown-item" href="<?= base_url("bondecommande/pdf_bdc_detail?id=".$b['idboncommande']."&fournisseur=".$b['idfournisseur']."&delai=".$b['delailivraison']) ?>"
                                            ><i class="bx bx-edit-alt me-1"></i> <?= $b['nomfournisseur'] ?>
                                    </a> 
                                </span>
                            </td>
                        </tr>
