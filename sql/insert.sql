...
INSERT INTO poste (nomPoste, idService) VALUES
    ('Developpeur de logiciels', 3),
    ('Ingenieur en securite informatique', 3),
    ('Administrateur systeme', 3);

-- Service Logistique
INSERT INTO poste (nomPoste, idService) VALUES
    ('Gestionnaire de la chaine d''approvisionnement', 4),
    ('Responsable logistique', 4),
    ('Analyste de la chaine d''approvisionnement', 4);

-- Service Production industrielle
INSERT INTO poste (nomPoste, idService) VALUES
    ('Operateur de machine industrielle', 5),
    ('Technicien de production', 5),
    ('Superviseur de production', 5);

-- Service Recherche et developpement
INSERT INTO poste (nomPoste, idService) VALUES
    ('Ingenieur de recherche', 6),
    ('Chercheur Scientifique', 6),
    ('Ingenieur en conception produit', 6);

-- Service Ressources humaines
INSERT INTO poste (nomPoste, idService) VALUES
    ('Responsable des ressources humaines', 7),
    ('Recruteur', 7),
    ('Gestionnaire de la paie', 7);

-- Service Maintenance et Reparation
INSERT INTO poste (nomPoste, idService) VALUES
    ('Technicien de Maintenance Industrielle', 8),
    ('Electricien de Batiment', 8),
    ('Plombier', 8);

-- Service Marketing
INSERT INTO poste (nomPoste, idService) VALUES
    ('Specialiste en Marketing Numerique', 9),
    ('Responsable des Medias Sociaux', 9),
    ('Chef de Produit', 9);
...
INSERT INTO personnel (matricule, nomPersonnel, login, motdepasse, idposte) VALUES
    ...
    ('MAT002', 'Jane Doe', 'jane.doe', 'motdepasse2', 1),
    ...
    ('MAT009', 'Olivia Miller', 'olivia.miller', 'motdepasse9', 4),
    ...
    ('MAT017', 'Ava Nelson', 'ava.nelson', 'motdepasse17', 7),
    ...
    ('MAT023', 'Chloe Bennett', 'chloe.bennett', 'motdepasse23', 10),
    ...
    ('MAT029', 'Olivia Hill', 'olivia.hill', 'motdepasse29', 13),
    ...
    ('MAT035', 'Sophia Watson', 'sophia.watson', 'motdepasse35', 16),
    ...
    ('MAT039', 'Emma Bailey', 'emma.bailey', 'motdepasse39', 18),
    ...
    ('MAT048', 'Daniel Foster', 'daniel.foster', 'motdepasse48', 16),
    ('MAT049', 'Natalie Young', 'natalie.young', 'motdepasse49', 21),
    ('MAT050', 'Victor Carter', 'victor.carter', 'motdepasse50', 1);
...
INSERT INTO postePersonnel (idPersonnel, idPoste, dateEmbauche) VALUES
    ...
    ('MAT048', 16, '2022-12-10'),
    ('MAT049', 21, '2023-01-05'),
    ('MAT050', 1, '2023-02-20');

-- Insertion de chefs de service pour chaque service
INSERT INTO chef_service (idPersonnel, idService) VALUES
